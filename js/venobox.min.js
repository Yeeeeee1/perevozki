        ...
        this.each(function () {
          function Y() {
            (y = T.data("gall")),
              ...
              (C = p.eq(p.index(T) - 1)),
              p.length > 1
                ? ((B = p.index(T) + 1), a.html(B + " / " + p.length))
                : (B = 1),
              h === !0 ? a.show() : a.hide(),
              "" !== x ? s.show() : s.hide(),
              w.length || b === !0
          ...
          function N() {
            ...
            return o === !1
              ? !1
              : (e("body").off("keydown", D).removeClass("vbox-open"),
                T.focus(),
          ...
          function z(e) {
            if (startouch === !0) {
              ...
              o > t &&
                100 >= o &&
                (e.preventDefault(), r.css("margin-left", diffX));
            }
          }
          function R(e) {
            if (startouch === !0) {
          ...
          function Q() {
            s.html(x),
              r
                .find(">:first-child")
                .addClass("figlio")
                .css({ width: v, height: u, padding: i, background: t }),
          ...
          (O.VBclose = function () {
            ...
            T.on("click", function (b) {
              ...
              switch (
                ...
                (g = T.data("overlay") || T.data("overlaycolor")),
                (v = T.data("framewidth")),
              ...
              return (
                ...
                e(".vbox-num").css(X.numerationPosition, "-1px"),
                e(".vbox-num").css({
          ...
          var L = function (o) {
            ...
            oe = function (o, t, a, s) {
              return e.Event(o, { pageX: a, pageY: s, originalEvent: t });
            };
